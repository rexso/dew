...
module dew.geotiff.geo_keyp;

extern(C):
public:
nothrow:

// This structure contains the internal program representation of the key entry
struct GeoKey
{
...
// This structure represents the file-organization of the key entry. Note that it assumes that short entries are aligned along 2-byte boundaries.
struct KeyEntry
{
...
struct gtiff
{
	...
	_TIFFMethod	gt_methods;		// TIFF i/o methods
...
enum
{
	MAX_KEYINDEX	= 65535,	// largest possible key
	MAX_KEYS		= 100,      // maximum keys in a file
	MAX_VALUES		= 1000      // maximum values in a tag
}
